enum TokenType {
  ...
  //! cronosChain('Cronos Chain', 'CRO', 'assets/coins/10000025.webp'), Отсутствует наа Binance
  //! cryptoOrg('Crypro.org', 'CRO', 'assets/coins/10000025.webp'), Отсутствует наа Binance
  ethereum('Ethereum', 'ETH', 'assets/coins/60.webp'),
  litecoin('Litecoin', 'LTC', 'assets/coins/2.webp'),
  //! near('NEAR', 'NEAR', 'assets/coins/397.webp'), Проблемы с иконкой
